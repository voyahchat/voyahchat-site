...
class TelegramConfig {
    ...
    async loadTelegramConfig() {
        ...
        try {
            ...
            // For new format, sections should be in chat.sections
            // For old format, sections should be at root level
            const sections = this.telegramConfig.chat?.sections || this.telegramConfig.sections;
    ...
    async getSections() {
        ...
        return config.chat?.sections || config.sections;
    }
