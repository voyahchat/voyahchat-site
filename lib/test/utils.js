...
/**
 * Clean up TestDir by removing all files and directories
 * @param {TestDir} dir - TestDir instance to clean
 * @returns {Promise<void>}
 */
async function cleanupTestDir(dir) {
    try {
        await fs.promises.rm(dir.getRoot(), { recursive: true, force: true });
    } catch (error) {
