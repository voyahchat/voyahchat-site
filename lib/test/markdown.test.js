...
test('Markdown rendering - should process large markdown files efficiently', (t) => {
    ...
    // Should complete within 15 seconds for 1000 sections
    t.true(duration < 15000, `Processing took ${duration}ms, should be under 15000ms`);
...
> Quote ${i}`);
    ...
    // Should complete within 60 seconds for 500 sections with complex content
    t.true(duration < 60000, `Processing took ${duration}ms, should be under 60000ms`);
