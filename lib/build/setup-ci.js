 ...
 * CI Setup Script
 *
 * Updates AVA configuration to exclude nginx-integrity tests in CI environment.
...
/**
 * Update AVA configuration to exclude nginx-integrity tests in CI
 * These tests require nginx which is not available in CI environment
...
function updateAvaConfig() {
    ...
    try {
        ...
        // Add the nginx-integrity test exclusion
        ...
        log('  AVA configuration updated for CI environment');
        return true;
